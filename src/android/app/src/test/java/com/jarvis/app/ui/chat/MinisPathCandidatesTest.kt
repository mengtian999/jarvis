...
/**
 * [T-android-jarvis-url-double-encoding] Decode candidates for a `jarvis://`
 * path.
 *
 * The field report: `jarvis://workspace/厚升凭证拆分/厚博-2026-03-935.pdf` was
 ...
 * to `ChatLinkAction.Web`, and a web preview of a `jarvis://` URL renders
