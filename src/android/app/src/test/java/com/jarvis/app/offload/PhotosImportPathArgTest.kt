package com.jarvis.app.offload

import com.jarvis.app.sandbox.offload.OffloadArgs
...
class PhotosImportPathArgTest {
    ...
    fun `positional path is accepted`() {
        assertEquals("/var/jarvis/offloads/p.jpg", resolvePath(listOf("import", "/var/jarvis/offloads/p.jpg")))
    }

    @Test
    fun `path flag still works`() {
        assertEquals("/var/jarvis/offloads/p.jpg", resolvePath(listOf("import", "--path", "/var/jarvis/offloads/p.jpg")))
    }
