...
class ModelsCollection(
    ...
    override fun add(payload: ConfigValue): String {
        ...
        // (CLI-facing alias documented in `jarvis-config` help). Either
    ...
    /**
     * Canonical names matching `jarvis-model-use list` so the two tools
    ...
    private fun effectiveModalities(e: ModelEntry): List<String> {
        ...
        // direction-suffixed names that match `jarvis-model-use list`.
