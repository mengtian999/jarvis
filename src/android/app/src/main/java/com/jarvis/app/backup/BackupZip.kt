...
/**
 * ZIP packaging for `.jarvisbak`, on both sides of the wire.
 *
...
object BackupZip {
     ...
     * `jarvisbak-<uuid>/manifest.json` rather than bare `manifest.json`.
     */
     ...
     *
     * After extraction the real package root may be `<dest>/jarvisbak-<uuid>/`
