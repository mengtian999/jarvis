    ...
    val webView: WebView = WebView(appContext).apply {
        ...
        webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(
                ...
                if (com.jarvis.app.browser.GoogleAuthRouter.shouldRouteExternally(urlStr)) {
                    if (urlStr != null) {
                        com.jarvis.app.browser.GoogleAuthRouter.openInCustomTab(view.context, urlStr)
                    }
                    return true
                }
                ...
                return com.jarvis.app.ui.browser
