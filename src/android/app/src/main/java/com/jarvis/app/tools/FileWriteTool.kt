...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/jarvis/workspace/...,
            // /var/jarvis/attachments/..., /var/jarvis/offloads/...,
            // /var/jarvis/browser/... land in this session's host dir
            ...
            // /var/jarvis/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/jarvis/mounts/")) {
