...
class PersistentShell(
    ...
    private fun startProcess() {
        ...
        val debugOffload = com.jarvis.app.BuildConfig.DEBUG
        ...
        // __JARVIS_DONE__ marker detection). Release keeps the original
        ...
        if (debugOffload) env["JARVIS_NOFF_DEBUG"] = "1"
        ...
        env["JARVIS_CHAT_SESSION_ID"] = sessionId
        ...
        try {
            ...
            while (true) {
                ...
                if (cb != null) {
                    ...
                    val markerExitPattern = "__JARVIS_DONE_${cb.marker}_EXIT_"
    ...
    private fun parseExitCode(text: String, marker: String): Int {
        // Pattern: __JARVIS_DONE_{marker}_EXIT_{code}__
        val regex = Regex("__JARVIS_DONE_${Regex.escape(marker)}_EXIT_(\\d+)__")
     ...
     *   {command}; echo "__JARVIS_DONE_{marker}_EXIT_$?__"
     *
    ...
    suspend fun executeCommand(
        ...
        val wrappedCommand = "$command\necho \"__JARVIS_DONE_${marker}_EXIT_\$?__\"\n"
