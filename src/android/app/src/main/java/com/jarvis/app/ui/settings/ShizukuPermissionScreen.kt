...
import com.jarvis.app.offload.ShizukuBackend
 ...
 *                        installed manager.
 *   NEED_PERMISSION   → "Authorize Jarvis" CTA → triggers system dialog.
        ...
        SettingsSection(
            ...
            SettingsRow(
                ...
                subtitle = if (snap.state == ShizukuManager.State.READY) {
                    ...
                    // user can see their root module is what's serving Jarvis.
                    if (snap.isSui) {
