...
import com.jarvis.app.accessibility.AccessibilityRecoveryManager
...
import com.jarvis.app.deeplink.DeepLinkHandler
import com.jarvis.app.logging.AppLogger
import com.jarvis.app.service.SessionActivityTracker
import com.jarvis.app.ui.navigation.AppNavigation
import com.jarvis.app.ui.navigation.Routes
import com.jarvis.app.ui.navigation.safeNavigate
import com.jarvis.app.ui.NewerDatabaseGuidanceScreen
import com.jarvis.app.ui.settings.KEY_FONT_APP_BASE
import com.jarvis.app.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.jarvis.app.ui.settings.KEY_LANGUAGE
import com.jarvis.app.ui.settings.KEY_LAUNCH_SESSION
import com.jarvis.app.ui.settings.KEY_THEME_MODE
import com.jarvis.app.ui.settings.PREF_APPEARANCE
import com.jarvis.app.ui.settings.getAppearancePrefs
import com.jarvis.app.ui.settings.fontScaleForLevel
import com.jarvis.app.ui.settings.keepScreenAwakeEnabled
import com.jarvis.app.ui.theme.MinisTheme

private const val KEY_CURRENT_CHAT_SESSION_ID = "jarvis.current_chat_session_id"
...
class MainActivity : ComponentActivity() {
     ...
     * [com.jarvis.app.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.jarvis.app.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (minisApp != null &&
            ...
            com.jarvis.app.data.db.DatabaseVersionGuard.Decision.SHOW_NEWER_DB_GUIDANCE
        ) {
        ...
        if (minisApp == null || !minisApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.jarvis.app.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.jarvis.app.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
                ...
                // tapped, reading as "Jarvis won't open at all". The process
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.jarvis.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.jarvis.app.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.jarvis.app.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                // T-config: root-level jarvis-config confirm dialog.
                ...
                com.jarvis.app.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.jarvis.app.ui.navigation.AppNavigation]
    ...
    private fun handleDeepLink(uri: Uri?) {
        ...
        when (action) {
            ...
            is DeepLinkAction.OpenAlarmList -> {
                // T297: jarvis://views/alarm now opens the system Clock app
