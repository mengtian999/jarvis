 ...
 *
 * Linux-visible mount: `/var/jarvis/offloads/tools/<file>`. The host base
 * `filesDir/jarvis-sessions/<sid>/offloads` is bind-mounted into the
 * sandbox by [com.jarvis.app.sandbox.PRootKernel.perSessionSubdirs]
...
object ContextOffload {
    ...
    const val LINUX_OFFLOADS_DIR = "/var/jarvis/offloads"
    ...
    fun toolsDir(context: Context, sessionId: String): File =
        File(context.filesDir, "jarvis-sessions/$sessionId/offloads/tools")
