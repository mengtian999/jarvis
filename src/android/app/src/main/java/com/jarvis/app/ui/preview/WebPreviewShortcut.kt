package com.jarvis.app.ui.preview
...
/**
 * Helper that pins a `file:///var/jarvis/...` HTML preview as a launcher
 * shortcut. Clicking the shortcut from the home screen sends a
 * `jarvis://preview/html?path=...&title=...` deep link back to
 * [MainActivity], which [com.jarvis.app.deeplink.DeepLinkHandler] parses
 * into [com.jarvis.app.deeplink.DeepLinkAction.OpenHtmlPreview]; the
...
object WebPreviewShortcut {
    ...
    fun pin(
        ...
        // file:///var/jarvis/browser/snake.html → /browser/snake.html
        val resourcePath = absPath.removePrefix("/var/jarvis").let {
        ...
        // jarvis://session/<sessionId>/<resource-path>?title=<title>
