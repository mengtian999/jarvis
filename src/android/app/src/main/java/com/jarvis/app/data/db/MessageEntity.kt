...
data class MessageEntity(
    ...
    // Only assistant rows carry a non-null roleId; user/system rows are null.
    // Synced across devices (NOT device-local like error_info). Orphan refs
    // (role deleted) render via RoleStore.loadDefault() fallback — same
    // strategy as folder_id.
