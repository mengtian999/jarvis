...
data class SelectionToolbarActions(
     ...
     * through Jarvis TTS. Null hides the button. Mirrors iOS's "Read Selection".
     */
    val onReadAloud: ((String) -> Unit)? = null,
    /**
     * [T-role-forward] Forward the message that owns the active selection to
     * another role. Null hides the button. The host resolves the owning
     * message id from the selection controller.
     */
    val onForward: (() -> Unit)? = null,
    /**
     * [T-role-forward] Enter multi-select mode with the message that owns the
     * active selection pre-selected. Null hides the button.
     */
    val onMultiSelect: (() -> Unit)? = null,
    /**
    ...
    Popup(
        ...
        Surface(
            ...
            Row(
                ...
                val labelCopy = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copy)
                val labelAddToInput = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_add_to_chat_input)
                val labelCopyFullText = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copy_full_text)
                val labelCopyAsMarkdown = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copy_as_markdown)
                val labelCopyAsRichText = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copy_as_rich_text)
                val labelCopyAsPlainText = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copy_as_plain_text)
                val toastCopiedAsPlainText = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copied_as_plain_text_toast)
                ...
                val labelReadSelection = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_read_aloud)
                val labelReadFromStart = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_read_from_start)
                val labelReadAloud = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.read_aloud_group)
                val toastCopiedAsMarkdown = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copied_as_markdown_toast)
                val toastCopiedAsRichText = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_copied_as_rich_text_toast)
                val labelForward = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_forward)
                val labelMultiSelect = androidx.compose.ui.res.stringResource(com.jarvis.app.R.string.selection_multiselect)
                ...
                val labelCopyTable = androidx.compose.ui.res.stringResource(
                    com.jarvis.app.R.string.markdown_table_copy_table)
                val labelCopyTableImage = androidx.compose.ui.res.stringResource(
                    com.jarvis.app.R.string.markdown_table_copy_table_image)
                ...
                val items = buildList {
                    add(SelectionAction(labelCopy) {
                        ...
                        if (text.isNotEmpty()) {
                            ...
                            toast(context.getString(
                                com.jarvis.app.R.string.selection_copied_toast, preview(text)))
                        }
                        controller.clearSelection()
                    })
                    ...
                    // [T-role-forward] Forward / multi-select the message that
                    // owns this selection. Placed in the overflow (⋯) menu
                    // alongside Copy Markdown / Copy Rich Text so the inline bar
                    // stays narrow; the host resolves the owning message id.
                    if (actions?.onForward != null) {
                        add(SelectionAction(labelForward) {
                            actions?.onForward?.invoke()
                            controller.clearSelection()
                        })
                    }
                    if (actions?.onMultiSelect != null) {
                        add(SelectionAction(labelMultiSelect) {
                            actions?.onMultiSelect?.invoke()
                            controller.clearSelection()
                        })
                    }
