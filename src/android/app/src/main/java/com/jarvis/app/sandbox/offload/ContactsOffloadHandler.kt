                ...
                r = OffloadPermissionManager.requestSettingsGate(
                    OffloadPermissionManager.SettingsGateRequest(
                        ...
                        message = if (needsWrite) {
                            "Jarvis needs read + write contacts permission to delete entries. Open Settings to allow it."
                        } else {
                            "Jarvis needs contacts permission to read your address book. Open Settings to allow it."
                        },
