package com.jarvis.app.provider.gemini
...
class GeminiProvider(
    ...
    override suspend fun sendMessageClamped(
        ...
        val request = Request.Builder()
            ...
            // can trace the request back to the Jarvis build. Gemini has no
    ...
    private fun rawStreamMessage(
        ...
        val request = Request.Builder()
            ...
            // branch above — brand outbound requests with Jarvis/<version>.
            .applyUserAgentOverride(null)
            .build()
