...
import com.jarvis.app.provider.voice.VoiceInputRequest
import com.jarvis.app.provider.voice.VoiceProvider
import com.jarvis.app.provider.voice.VoiceProviderException
import com.jarvis.app.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.jarvis.app.data.repository.ProviderRepository,
        candidates: List<Pair<com.jarvis.app.data.model.ProviderInstance, com.jarvis.app.data.model.ModelEntry>>,
