...
/**
 * Exposes `<filesDir>/jarvis-global/{memory,skills,shared}` to the system
 ...
 *     android:authorities="com.jarvis.app.documents"
...
class MinisDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.jarvis.app.documents"
        private const val ROOT_ID = "jarvis-root"
    ...
    private fun providerRoot(): File {
        ...
        return File(ctx.filesDir, "jarvis-global").apply { mkdirs() }
    }
    ...
    override fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        ...
        val displayName = if (documentId.isEmpty()) "Jarvis" else file.name
        cursor.newRow()
