package com.jarvis.app.speech.correction

import android.content.Context
import android.util.Log
import com.jarvis.app.MinisApp
import com.jarvis.app.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        val dao = runCatching {
            com.jarvis.app.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<com.jarvis.app.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)
