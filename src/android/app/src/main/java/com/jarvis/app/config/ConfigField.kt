...
/**
 * One configurable setting. Concrete kinds: [com.jarvis.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.jarvis.app.config.fields.ClosureField]
...
interface ConfigField {
     ...
     * already blocks these entries, and jarvis-config must not be a side door
     * around that gate.
     *
