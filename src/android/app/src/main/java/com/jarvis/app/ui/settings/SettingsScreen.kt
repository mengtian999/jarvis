...
import com.jarvis.app.ui.components.openExternalUrl
import com.jarvis.app.i18n.uppercaseForDisplay
...
fun SettingsScreen(
    ...
    onMcpClick: () -> Unit = {},
    // [T-role-multi] Role settings page lives between Skills and Memory in the
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsSection(title = stringResource(R.string.settings_section_agent_runtime)) {
                ...
                // [T-role-multi] insertion between Skills and Memory per spec.
                SettingsItem(
                    icon = Icons.Outlined.AutoAwesome,
                    iconColor = Color(0xFFFF9500),
                    title = stringResource(R.string.settings_role),
                    subtitle = stringResource(R.string.settings_role_subtitle),
                    onClick = onRoleClick,
                )
                SettingsItem(
...
private fun buildBugReportUrl(): String {
    ...
    val body = """
        ...
        | Jarvis Version | $versionName (build $versionCode) |
