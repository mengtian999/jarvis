...
object MemoryTools {
    ...
    fun executeMemoryWrite(inputJson: String, repository: MemoryRepository, roleId: String? = null): ToolResult {
        return try {
            ...
            if (content.isBlank()) {
                ...
                val result = repository.writeMemory(content, roleId)
    ...
    fun executeMemoryGet(inputJson: String, repository: MemoryRepository, roleId: String? = null): ToolResult {
        return try {
            val obj = JSONObject(inputJson)
            ...
            val result = repository.getMemory(keywords, scope, roleId)
