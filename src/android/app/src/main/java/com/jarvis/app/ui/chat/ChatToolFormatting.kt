...
// Helper: tool display name for "Jarvis is using X"
...
/**
 * Full "Jarvis is …" label shown in the tool detail sheet's bottom bar.
...
internal fun toolTitleLabel(toolName: String): String = when (toolName) {
    ...
    else -> "Jarvis is using ${toolDisplayName(toolName)}"
}
