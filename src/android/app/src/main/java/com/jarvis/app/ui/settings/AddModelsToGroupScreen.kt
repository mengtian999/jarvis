...
import com.jarvis.app.ui.components.PickerModalityFilter
import com.jarvis.app.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.jarvis.app.data.model.ModelEntry?>(null) }
