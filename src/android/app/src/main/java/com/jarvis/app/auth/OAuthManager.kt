...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun hasStoredCredential(context: Context, instanceId: String): Boolean {
            val prefs = com.jarvis.app.util.EncryptedPrefsFactory
        ...
        fun forInstance(context: Context, instance: com.jarvis.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.jarvis.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.jarvis.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.jarvis.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.jarvis.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.jarvis.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
