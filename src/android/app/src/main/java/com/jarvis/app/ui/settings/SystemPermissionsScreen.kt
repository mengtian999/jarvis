...
import com.jarvis.app.power.PowerOptimizationManager
    ...
    Scaffold(
        ...
        Column(
            ...
            if (a11yRestricted) {
                SettingsSection(
                    ...
                    SettingsRow(
                        ...
                        // Lands on Jarvis' own App info page, where the
            ...
            var correctionEnabled by remember {
                mutableStateOf(
                    com.jarvis.app.speech.correction.VoiceCorrectionConsent.isEnabled(context),
                )
            }
