 ...
 * [com.jarvis.app.logging.AppLogger.listLogFiles] already filters
...
class CrashFileSender : ReportSender {
    ...
    override fun send(context: Context, errorContent: CrashReportData) {
        ...
        val body = buildString {
            appendLine("=== Jarvis Java/Kotlin Crash ===")
    ...
    companion object {
        ...
        // alongside the daily jarvis-YYYY-MM-DD.log files (which AppLogger
