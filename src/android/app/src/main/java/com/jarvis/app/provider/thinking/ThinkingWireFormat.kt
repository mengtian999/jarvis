 ...
 * [com.jarvis.app.provider.openai.OpenAIProvider]). Gemini and Anthropic have their
...
sealed interface ThinkingWireFormat {
     ...
     * official endpoint reasons by default and its real switch lives here; Jarvis never
