package com.jarvis.app.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.jarvis.app.service.SessionActivityTracker]
 ...
 *   `jarvis://session/<sessionId>` (existing
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.jarvis.app.service.SessionActivityTracker] when a
    ...
    companion object {
        ...
        const val CHANNEL_ID = "jarvis_task_completed"
    }
}
