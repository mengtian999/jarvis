 ...
 * ## Why this exists
 *
 * A user on Redmi Note 12 Pro+ 5G (HyperOS 2.0.10 / Android 14) updated Jarvis
 * from the website and could no longer enable the accessibility service
 * backing `android-a11y-cli`: tapping Jarvis under Settings → Accessibility
 ...
 *
 * ## Root cause (an OS policy, not a Jarvis regression)
 *
 ...
 *
 * Nothing changed in Jarvis. What changed is how that particular copy was
 ...
 *
 * It does not change how Jarvis is packaged or installed, and deliberately so.
...
object RestrictedSettingsManager {
     ...
     * `appops set com.jarvis.app ACCESS_RESTRICTED_SETTINGS allow`.
     *
