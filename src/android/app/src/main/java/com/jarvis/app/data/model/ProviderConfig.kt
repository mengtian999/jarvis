...
data class ProviderInstance(
     ...
     */
    @Serializable(with = com.jarvis.app.backup.Iso8601MillisSerializer::class)
    ...
    // an official client (e.g. Claude Code); Jarvis' default UA gets rejected.
...
data class ModelEntry(
    ...
    @Serializable(with = com.jarvis.app.backup.Iso8601MillisNullableSerializer::class)
...
data class ProviderConfig(
    ...
    // Models and groups exposed to the agent loop (jarvis-model-use terminal
