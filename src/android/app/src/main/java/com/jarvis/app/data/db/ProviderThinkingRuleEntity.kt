 ...
 * in [com.jarvis.app.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    /** Stable UUID assigned at creation; the drag-reorder target and jarvis-config handle. */
    ...
    /** Serialized [com.jarvis.app.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
