...
#
#     /var/jarvis/mcp-servers/oauth/<server>.json
...
OAUTH_DIR = "/var/jarvis/mcp-servers/oauth"
...
def _authorize_deeplink(server_name):
    ...
    return "[Authorize](jarvis://settings/mcp-servers/%s)" % quote(server_name, safe="")
    ...
    def initialize(self):
        result = self._post(
            "initialize",
            {
                ...
                "capabilities": {},
                "clientInfo": {"name": "jarvis-mcp-cli", "version": "1.0.0"},
            },
        )
