...
//  MinisApp
//
//  Routes guest paths under /var/jarvis/{offloads,attachments,workspace,browser}
...
final class MinisFsRouter: @unchecked Sendable {
    ...
    /// /var/jarvis/{memory,skills,shared} stay global and are NOT listed here —
    ...
    /// return the canonical guest path /var/jarvis/<bucket>/<tail>.
