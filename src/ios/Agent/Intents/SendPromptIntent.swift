...
/// Sends a prompt to the Jarvis AI agent and returns immediately with structured session info.
...
struct SendPromptIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a prompt to the Jarvis AI agent. Returns session info immediately while the task runs in the background.")
    ...
    @Parameter(title: "Prompt",
               requestValueDialog: "What would you like to ask Jarvis?",
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<SendPromptResult> & ProvidesDialog {
        ...
        if sendCompletionNotification {
            ...
            ShortcutNotification.post(
                ...
                title: AppLocalized("Jarvis Task Started"),
        ...
        if waitForResult {
            ...
            if sendCompletionNotification {
                ShortcutNotification.post(
                    ...
                    title: AppLocalized("Jarvis Task Completed"),
