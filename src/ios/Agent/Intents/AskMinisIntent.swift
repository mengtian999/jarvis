...
/// Siri-facing "ask Jarvis" entry point. Unlike `SendPromptIntent` (which runs
...
/// conversation — matching the "Hey Siri, ask Jarvis to …" experience.
///
...
struct AskMinisIntent: AppIntent {
    ...
    static var description = IntentDescription("Opens Jarvis, sends your prompt, and shows the conversation. Starts a new session, or continues an existing one when you pick a session.")
    ...
    @Parameter(title: "Prompt", requestValueDialog: "What would you like to ask Jarvis?")
    var prompt: String
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "On it — opening Jarvis.")
    }
}
