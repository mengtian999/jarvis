...
// MARK: - Kernel Boot + Prompt Queue + Jarvis paths + Dynamic Max Tokens
...
extension AIChatViewModel {
        ...
        Task {
            ...
            do {
                if !ISHKernel.shared.isBooted {
                    ...
                    // /var/jarvis/* access already routes correctly.
    ...
    // MARK: - /var/jarvis/ Shared Directory
    //
    // Unified bidirectional file area between iOS and iSH:
    //   /var/jarvis/attachments/  — screenshots, images, media
    //   /var/jarvis/offloads/     — large tool outputs (migrated from /var/offloads/)
    //   /var/jarvis/workspace/    — general session working area
    //
    // Persistent storage: Library/MinisChat/minis/<sessionId>/{attachments,offloads,workspace}/
    // iSH-visible path:   /var/jarvis/{attachments,offloads,workspace}/  (session-unaware)
    //
    // On session load/switch, the current session's files are synced into the
    // iSH-visible directory so the model and shell commands always see /var/jarvis/.

    nonisolated static let minisLinuxBaseDir = "/var/jarvis"
    nonisolated static let minisAttachmentsLinuxDir = "/var/jarvis/attachments"
    nonisolated static let minisOffloadsLinuxDir = "/var/jarvis/offloads"
    nonisolated static let minisWorkspaceLinuxDir = "/var/jarvis/workspace"
    nonisolated static let minisBrowserLinuxDir = "/var/jarvis/browser"
    nonisolated static let minisMemoryLinuxDir = "/var/jarvis/memory"
    nonisolated static let minisSkillsLinuxDir = "/var/jarvis/skills"
    nonisolated static let minisSharedLinuxDir = "/var/jarvis/shared"
    nonisolated static let minisMcpServersLinuxDir = "/var/jarvis/mcp-servers"
    nonisolated static let minisMountsLinuxDir = "/var/jarvis/mounts"
