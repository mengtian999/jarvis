...
// MARK: - Request-level image budget + Jarvis paths + tool-output offload
...
extension AIChatViewModel {
    ...
    /// directory and return the iSH-visible `/var/jarvis/attachments/spillover/...`
    ...
    private static func ensureSpillover(_ data: Data, mimeType: String, sessionId: String) -> String? {
        ...
        return "/var/jarvis/attachments/spillover/\(sha).\(ext)"
    }
    ...
    /// memory) here — anything else leaks into "On My iPhone → Jarvis".
