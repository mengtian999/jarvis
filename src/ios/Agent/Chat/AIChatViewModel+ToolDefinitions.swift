        ...
        var tools: [AgentToolDefinition] = [
            ...
            AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Absolute Linux path to read (e.g. /var/jarvis/workspace/data.csv)"),
        ...
        if nativeVision || visionGroupConfigured {
            ...
            tools.append(AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Linux path (e.g. /var/jarvis/attachments/chart.png) or jarvis:// URL (e.g. jarvis://attachments/chart.png)"),
