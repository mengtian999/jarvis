...
// MARK: - Jarvis URL Capture Broker
...
final class MinisOpenURLBroker: ObservableObject {
    ...
    /// preview nested on top of itself instead. `jarvis://` resource
    ...
    /// ToolLiveSheet.linkPreviewURL). `jarvis://` resources render as
