...
for (label, name) in [("wrapper + nested file", "jarvisbak-UUID/data/messages.jsonl"),
                      ("blob path", "jarvisbak-UUID/blobs/ab/abcdef0123.blob"),
                      ("unicode filename", "jarvisbak-UUID/文件/résumé.md"),
                      ("empty directory entry", "jarvisbak-UUID/blobs/"),
                      ("deep non-existent leaf", "jarvisbak-UUID/a/b/c/d.json"),
                      ("symlink staying inside root", "inner/ok.txt"),
                      ("dot in filename", "jarvisbak-UUID/data/a.b.c.jsonl"),
                      ("space in filename", "jarvisbak-UUID/my file.txt")] {
