...
enum DebugMethodRegistry {
    ...
    static let methods: [MethodSpec] = [
        ...
        MethodSpec(
            ...
            description: "Build a .jarvisbak package (export only; unencrypted, stage 1).",
            params: [
                ...
                ParamSpec(name: "passphrase", type: "string", required: false, default: nil,
                          description: "Encrypt the package (jarvisbak-enc/1). REQUIRED when credentials are included."),
                ParamSpec(name: "deliver", type: "boolean", required: false, default: false,
                          description: "Move the package into Files-visible shared storage (Jarvis ▸ Backups), the path the Backup UI uses."),
            ],
        ...
        MethodSpec(
            ...
            description: "Import a .jarvisbak package (stage 2: Merge mode, unencrypted).",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .jarvisbak file"),
                ParamSpec(name: "categories", type: "array", required: false, default: nil,
            ...
            example: ["path": "/…/backup.jarvisbak"]
        ),
        MethodSpec(
            name: "debug.backup.cleanup",
            description: "Delete .jarvisbak packages left in Documents by export {keep:true}.",
            params: [],
        ...
        MethodSpec(
            ...
            description: "Salvage what can be read from a damaged .jarvisbak: rescue.json, manifest.json, its tail copy, and the surviving member list.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the (possibly damaged) .jarvisbak file"),
            ],
        ...
        MethodSpec(
            ...
            params: [
                ...
                ParamSpec(name: "deliver", type: "string", required: false, default: nil,
                          description: "Path to a .jarvisbak to copy to every destination"),
            ],
        ...
        MethodSpec(
            ...
            description: "Drive the 'opened a .jarvisbak from Files' entry point (BackupOpenRouter.handle) and report whether the root restore sheet would present.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .jarvisbak file to open"),
            ],
            returns: "{recognisedAsPackage, handled, pendingPackage, hasPendingPackage, appIsLocked, sheetWouldPresent}",
            example: ["path": "/…/backup-20260814-0230.jarvisbak"]
        ),
        MethodSpec(
            name: "debug.backup.inspect",
            description: "List a .jarvisbak package's entries and read back its manifest.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .jarvisbak file"),
            ],
        ...
        MethodSpec(
            ...
            example: ["name": "jarvis", "table": "messages"]
        ),
        MethodSpec(
            name: "debug.db.query",
            ...
            example: ["name": "jarvis", "sql": "SELECT role, COUNT(*) c FROM messages GROUP BY role", "limit": 20]
        ),
        MethodSpec(
