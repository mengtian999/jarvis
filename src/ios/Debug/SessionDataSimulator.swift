    ...
    private static func mixedScenario() -> [ParsedMessage] {
        [
            ...
            ParsedMessage(role: .assistant, blocks: [
                ...
                ParsedBlock(kind: .shellTool(command: "xcodebuild test -scheme Jarvis -destination 'platform=iOS Simulator,name=iPhone 15'"), content: "xcodebuild test ...", toolStatus: .success),
                tb("""
                All tests passed:
    ...
    private static func toolHeavyScenario() -> [ParsedMessage] {
        [
            ...
            ParsedMessage(role: .assistant, blocks: [
                ...
                ParsedBlock(kind: .shellTool(command: "xcodebuild test -scheme Jarvis -only-testing:AuthTests"), content: "xcodebuild test", toolStatus: .failed(message: "xcodebuild: error: Testing failed.")),
                ...
                ParsedBlock(kind: .shellTool(command: "xcodebuild test -scheme Jarvis -only-testing:AuthTests"), content: "xcodebuild test", toolStatus: .success),
                tb("""
