...
final class DebugJSONRPC: @unchecked Sendable {
    ...
    private func handleShellExecute(params: [String: Any]) async throws -> Any {
        ...
        // fs_context, so /var/jarvis/{offloads,attachments,workspace,browser}
    ...
    private func knownDatabases() -> [(name: String, url: URL)] {
        ...
        return [
            ("jarvis", chatBase.appendingPathComponent("minis.db")),
            ("skills", chatBase.appendingPathComponent("jarvis").appendingPathComponent("skills.db")),
