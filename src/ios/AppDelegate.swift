...
final class SceneDelegate: NSObject, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        // (or "Open in Jarvis") a file, the file:// URL arrives here in
    ...
    // app is ALREADY running, AirDrop / "Open in Jarvis" delivers the file URL
    ...
    private static func handleURLContexts(_ contexts: Set<UIOpenURLContext>, phase: String) {
        for context in contexts {
            ...
            Task { @MainActor in
                ...
                // A .jarvisbak must reach the restore flow, not the attachment
