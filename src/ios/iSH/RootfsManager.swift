...
class RootfsManager {
    ...
    func installIfNeeded() throws {
        ...
        // Pre-create /var/jarvis/ shared directory structure
        let jarvisSubdirs = ["var/jarvis/attachments", "var/jarvis/offloads", "var/jarvis/workspace", "var/jarvis/skills", "var/jarvis/shared"]
        for subdir in jarvisSubdirs {
