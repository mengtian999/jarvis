...
///
/// Without an explicit header, URLSession sends `Jarvis/<CFBundleVersion>
/// CFNetwork/… Darwin/…` — i.e. the **build number** (e.g. `Jarvis/1`), not the
...
/// e.g. `Jarvis/1.10 (iOS 26.5; iPhone)`.
///
...
enum MinisUserAgent {
    ...
    static var `default`: String {
        ...
        let ua = "Jarvis/\(version) (iOS \(osVersion); \(model))"
        cached = ua
        return ua
    }
}
