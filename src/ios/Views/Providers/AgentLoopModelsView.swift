...
struct AgentLoopModelsSection: View {
    ...
    var body: some View {
        Section {
            ...
            HStack {
                Text("Models Jarvis Can Call at Runtime")
                Spacer()
            ...
            Text("During a Jarvis task, the agent calls these models for sub-tasks such as generating an image or summarizing text — work its own model can't do. Also callable from the terminal via minis-model-use. Only these are visible to the agent.")
        }
    }
