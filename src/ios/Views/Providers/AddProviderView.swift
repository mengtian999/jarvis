                    ...
                    GroupBox {
                        VStack(alignment: .leading, spacing: 12) {
                            Text("We Do Not Collect Your Data")
                                .font(.headline)
                            Text("Jarvis does not operate any server and does not collect, store, or process any of your personal data. All data stays on your device.")
                                .font(.subheadline)
                                .foregroundStyle(.secondary)
                    ...
                    GroupBox {
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 6) {
                                ...
                                dataItem("No data is shared with Jarvis or any other party beyond the provider you select")
                            }
                        }
                    }
