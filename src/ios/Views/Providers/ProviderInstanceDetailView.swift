...
struct ProviderInstanceDetailView: View {
    ...
    private func customUserAgentSection(_ instance: ProviderInstance) -> some View {
        Section {
            ...
            Text(AppLocalized("Override the User-Agent header sent to this endpoint. Leave empty to use the Jarvis default. Useful for relays that only accept specific clients (e.g. \"claude-cli/1.0\")."))
        }
    }
