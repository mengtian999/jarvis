...
//  give it a custom name, and mount it at /var/jarvis/mounts/<name>.
//
...
struct MountedFoldersSettingsView: View {
    ...
    private func detailContext(for entry: MountedFolderEntry) -> MountDetailContext {
        ...
        // breadcrumb shows /var/jarvis/mounts/<name>.
        ...
        return MountDetailContext(
            kind: .external,
            linuxPath: "/var/jarvis/mounts/\(entry.name)",
...
private struct InfoBanner: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("Picked folders are bind-mounted at /var/jarvis/mounts/<name>. You can browse them in Browse Files and read/write them directly from the iSH shell, just like /var/jarvis/shared. Up to 10 folders can be mounted at a time.")
                .font(.caption)
                .foregroundStyle(.secondary)
...
private struct MountedFolderRow: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("/var/jarvis/mounts/\(entry.name)")
        ...
        NavigationStack {
            Form {
                ...
                Section(header: Text("Mount name")) {
                    ...
                    Text("This will be the folder name under /var/jarvis/mounts/")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
