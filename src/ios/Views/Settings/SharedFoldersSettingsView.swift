        ...
        List {
            Section {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text("These directories appear in iOS Files under On My iPhone → Jarvis. Tap a row to see details, browse, or toggle visibility.")
                        .font(.caption)
...
struct SharedFolderEntry: Identifiable, Hashable {
    ...
    /// Linux path inside iSH (e.g. "/var/jarvis/shared").
