...
struct ToolLiveSheet: View {
    ...
    var body: some View {
        ...
        //
        // Only intercepts http/https/about: URLs — `jarvis://` chat-resource
    ...
    private var toolTitle: String {
        switch block.kind {
        case .shellTool: return "Jarvis is using Shell"
        case .fileReadTool: return "Jarvis is reading File"
        case .fileWriteTool: return "Jarvis is using Editor"
        case .fileEditTool: return "Jarvis is editing File"
        case .browserTool: return "Jarvis is using Browser"
        case .readImageTool: return "Jarvis is reading Image"
        case .memoryTool: return "Jarvis is using Memory"
        case .info: return "Jarvis"
        case .text: return "Jarvis"
        case .thinking: return "Jarvis"
        }
    }
