...
static NSString *const HELP_TEXT =
    @"minis-browser-use - Drive the in-app WebView from the shell\n"
     ...
     "                   /var/jarvis/browser/ and referenced via image_path +\n"
     ...
     "                      /var/jarvis/browser/screenshot_<ms>.jpg\n"
     "    minis_url         jarvis://browser/<filename> — stable reference for\n"
     ...
     "                      /var/jarvis/browser/\n"
     "    fetched_minis_url jarvis://browser/<filename> for the download\n"
     "\n"
     "EXAMPLES:\n"
