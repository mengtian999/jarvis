...
static NSString *const HELP_TEXT =
    @"apple-vision - Image analysis using the Vision framework\n"
     ...
     "  Supports images in /var/jarvis/attachments/ and other accessible paths.\n"
     "\n"
     "EXAMPLES:\n"
     "  apple-vision ocr /var/jarvis/attachments/photo.jpg\n"
     "  apple-vision ocr /var/jarvis/attachments/doc.png --lang zh-Hans,en --level fast\n"
     "  apple-vision barcode /var/jarvis/attachments/qr.png --compact -q\n"
     "  apple-vision classify /var/jarvis/attachments/photo.jpg --limit 5\n"
     "  apple-vision analyze /var/jarvis/attachments/photo.jpg\n"
