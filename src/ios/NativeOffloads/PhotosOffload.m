...
static NSString *const HELP_TEXT =
    @"apple-photos - Query and manage the iOS photo library\n"
     ...
     "  export        Export a photo/video to /var/jarvis/offloads/\n"
     ...
     "                       Accepts guest paths (/var/jarvis/attachments/a.jpg),\n"
     ...
     "                       Accepts guest paths (/var/jarvis/...), paths relative\n"
     ...
     "  apple-photos import /var/jarvis/offloads/pic.jpg\n"
     "  apple-photos import --path /var/jarvis/offloads/pic.jpg\n"
     "  apple-photos import --path /var/jarvis/offloads/pic.jpg --album-name \"My Album\"\n"
     "  apple-photos save --path /var/jarvis/offloads/clip.mov --album <album-id>\n"
...
static int cmd_export(int argc, char **argv, int stdout_fd, int stderr_fd, BOOL compact, BOOL quiet) {
    ...
    NSString *guestDir = @"/var/jarvis/offloads";
...
//   1. Guest-absolute: "/var/jarvis/attachments/foo.jpg" → mapped into fakefs data dir.
