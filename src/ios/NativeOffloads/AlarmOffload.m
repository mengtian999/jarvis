...
#if __has_include("Jarvis-Swift.h")
...
static NSString *const HELP_TEXT =
    @"apple-alarm - Set alarms and timers on iOS (AlarmKit, iOS 26+)\n"
     ...
     "\n"
     "DEEP LINK:\n"
     "  jarvis://views/alarm              Open the alarm management page in Jarvis\n";
    ...
    if (!authorized) {
        NSString *msg = authError
            ? [NSString stringWithFormat:@"AlarmKit authorization failed: %@. "
                "To grant access, open Settings > Privacy & Security > Alarms and enable Jarvis.",
...
static int cmd_set_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"view_url"] = @"jarvis://views/alarm";
        data[@"hint"] = @"Alarm is now visible on the Jarvis home screen. Open jarvis://views/alarm to manage alarms.";
...
static int cmd_timer_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"view_url"] = @"jarvis://views/alarm";
        data[@"hint"] = @"Timer is now visible on the Jarvis home screen. Open jarvis://views/alarm to manage alarms.";
