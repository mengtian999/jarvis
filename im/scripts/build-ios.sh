...
FLUFFYCHAT_ORIG_GROUP="im.bitjarvis"
FLUFFYCHAT_ORIG_TEAM="4NXF6Z997G"
#FLUFFYCHAT_NEW_GROUP="com.example.bitjarvis"
...
2. Fix it yourself
    ...
    - Ensure that Xcode created the App ID successfully (for bitjarvis.app and bitjarvis.app.FluffyChat-Share)
...
[ -n "${FLUFFYCHAT_INSTALL_IPA}" ] && {
  ...
  cfgutil --foreach install-app "${TMPDIR}/bitjarvis.ipa"
  rm -rf "${TMPDIR}"
}
