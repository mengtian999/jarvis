...
import 'package:bitjarvis/pages/new_private_chat/new_private_chat_view.dart';
import 'package:bitjarvis/pages/new_private_chat/qr_scanner_modal.dart';
import 'package:bitjarvis/utils/adaptive_bottom_sheet.dart';
import 'package:bitjarvis/utils/clipboard.dart';
import 'package:bitjarvis/utils/fluffy_share.dart';
import 'package:bitjarvis/utils/platform_infos.dart';
import 'package:bitjarvis/utils/url_launcher.dart';
...
class NewPrivateChatController extends State<NewPrivateChat> {
  ...
  Future<void> copyUserId() async {
    final scaffoldMessenger = ScaffoldMessenger.of(context);
    final l10n = L10n.of(context);
    await copyToClipboard(Matrix.of(context).client.userID!);
    if (!mounted) return;
    scaffoldMessenger.showSnackBar(
