...
enum AppSettings<T> {
  ...
  pushNotificationsGatewayUrl<String>(
    ...
    'https://push.bitjarvis.chat/_matrix/push/v1/notify',
  ),
  ...
  applicationName<String>('chat.fluffy.application_name', 'Bit Jarvis'),
  defaultHomeserver<String>('chat.fluffy.default_homeserver', 'bitjarvis.chat'),
  ...
  website<String>('chat.fluffy.website_url', 'https://bitjarvis.chat'),
  logoUrl<String>(
    'chat.fluffy.logo_url',
    'https://bitjarvis.chat/assets/favicon.png',
  ),
